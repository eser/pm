...
(1,'Improvement','task_type'),
(2,'Bugfix','task_type'),
(3,'Feature','task_type'),
(4,'Project','project_type'),
(5,'Service','project_type'),
(6,'Opportunity','project_type'),
(7,'New','open_task_type'),
(8,'In Progress','open_task_type'),
(9,'Verification','open_task_type'),
(10,'Delayed','open_task_type'),
(11,'Closed','closed_task_type'),
(12,'Rejected','closed_task_type'),
(13,'Low','priority_type'),
(14,'Medium','priority_type'),
(15,'High','priority_type'),
(16,'Urgent','priority_type'),
(17,'Project Manager','project_relation_type'),
(18,'Project Member','project_relation_type');
UNLOCK TABLES;
...
(1,'test','Test Page','bold italic underline<div>test</div>',1,'menu');
UNLOCK TABLES;
...
(1,1,'Development','section_type'),
(2,1,'Maintenance','section_type'),
(3,1,'Setup Phase','milestone_type');
UNLOCK TABLES;
...
(1,'sample-project','Sample Project','...','Migrating the system to the new software','description',0,'2013-09-27 11:16:52',22,0,0,'',0);
UNLOCK TABLES;
...
(2,'Power User',1,1,0,0,1,1),
(3,'User',0,0,0,0,1,1),
(4,'Disabled',0,0,0,0,0,1);
UNLOCK TABLES;
...
(1,1,1,2,'Migration of old data','Transferring old data to the new one.',7,14,0,'2014-03-10 00:00:00',5,NULL,'2014-03-15 00:00:00',1,'2014-03-10 04:36:37',1,3),
(2,1,1,1,'Information entries','Form values validation during the submission, users will be alerted early instead of database errors.<div>(Can be supported with Javascript)</div>',7,14,0,'2014-03-10 00:00:00',15,NULL,'2014-03-22 00:00:00',1,'2014-03-10 04:38:33',1,3);
UNLOCK TABLES;
...
(2,'','Sample User','user','123456','noone@nohost.com','',2,'','',1);
UNLOCK TABLES;
