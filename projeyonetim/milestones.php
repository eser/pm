        ...
        <div class="box">
          ...
          <form class="fill-up">
            <div class="row-fluid">
              <div class="span12">
                <div class="padded">
                  ...
                  <div class="input">
                    <label for="Page" class="caption">Page</label>
                      <input type="text" placeholder="Page" name="Page"/>
                    
                  </div>
                  <div class="input">
                      <label for="StartDate" class="caption">Date</label>
            ...
            <div class="form-actions">
              ...
              <div class="pull-right">
                <button type="submit" class="button blue">Back</button>
              </div>
            </div>
          </form>
        </div>
