...
<section id="main">
  ...
  <div class="container-fluid">
    <div class="row-fluid">
      <div class="span6">
        <div class="box">
          <div class="tab-header"> New Upload
            ...
            <div class="row-fluid">
              <div class="span12">
                ...
                <div class="input">
                  ...
                  <div class="input">
                    <label for="File" class="caption" >File</label>
                  ...
                  <div class="input">
                    <label for="Version" class="caption">Version</label>
                      <input type="text" placeholder="Version" name="Version"/>
                    
                  </div>
                  <div class="input">
                    <label for="Issue" class="caption">Issue</label>
                  <select name="Issue" id="Issue" placeholder="Issue" class="fill-up chzn-select">
                    <option>NONE</option>
                  </select>
                </div>
                  <div class="input">
                    <label for="Milestone" class="caption">Milestone</label>
                  <select name="Milestone" id="Milestone" placeholder="Milestone" class="fill-up chzn-select">
                    <option>NONE</option>
                  </select>
                </div>
                  <div class="input">
