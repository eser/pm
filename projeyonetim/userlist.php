...
<nav id="secondary" class="main-nav">
  ...
  <ul class="secondary-nav-menu">
    <li class="">
     <a href="userlist.php"> 
     <i class="icon-share"></i>User List </a> </li>
    </ul>
</nav>
<section id="main">
  <div class="top-nav">
 ...
 <a href="useradd.php">
          ...
          <table class="table table-striped">
            ...
            <a href="#" class="button blue">Reset Password</a>
