...
<div id="modal" class="black-box modal hide fade">
  <div class="modal-header tab-header" >
    ...
    <span>Add Group</span> </div>
    
  <div class="modal-body separator" style="height:100px;">
  ...
  <div class="modal-footer">
    <div class="inner-well"> <a class="button mini rounded light-gray" data-dismiss="modal">Close</a> <a class="button mini rounded blue">Save</a> </div>
  </div>
</div>
    ...
    <div class="row-fluid">
      <div class="span12">
        <div class="box " style="position:relative;">
          <div class="tab-header" > User List
          </div>
          <div class="pull-right" style="margin-right:13px; margin-top:13px;">
               <a href="#" id="modal-link"> <button type="submit" class="button blue">Add Group</button></a>
              </div>
          ...
          <table class="table table-striped">
            <thead>
              <tr>
                ...
                <th>Phone</th>
                <th>Role</th>
                <th>Edit/Delete/Reset Password</th>
