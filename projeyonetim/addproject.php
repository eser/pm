            ...
            <div class="row-fluid">
              <div class="span12">
                <div class="padded">
                  ...
                  <div class="input">
                   <label for="Name" class="caption">Subtitle</label>
                      <input type="text" placeholder="Subtitle"/>
                    
                  </div>
                  <div class="input">
                    <label for="Name" class="caption">Short Description</label>
                      <input type="text" placeholder="Short Description"/>
                    
                  </div>
                  <div class="input">
                    <label for="Name" class="caption">License</label>
                  ...
                  <div class="input">
                     <label for="Name" class="caption">Icon</label>
                      <input type="text" placeholder="Icon"/>
                      <button type="button" class="button">Browse</button>
                    
                  </div>
                  <div class="input">
                     <label for="Name" class="caption">Parent</label>
                      <select name="Parent" id="Parent" placeholder="Parent" class="fill-up chzn-select">
                        <option>None</option>
                      </select>
                    
                  </div>
                  <div class="input">
                     <label for="Name" class="caption">Type</label>
                  ...
                  <div class="input">
                    ...
                    <label for="ch1_SourcForge">SourceForge</label>
                  </div>
                  <div class="input">
                    <input type="checkbox" id="ch2" class="normal-check" checked/>
                    <label for="ch2_Public">Public</label>
                  </div>
                </div>
              </div>
            </div>
